...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = R.color.lightGrey;
	private int underlineColor = R.color.underline;
	private int dividerColor = R.color.lightGrey;
	...
	private int tabTextColor = 0XFFC2C2C2;
	//tabTextColor will not accept a redirect to a resources file.
