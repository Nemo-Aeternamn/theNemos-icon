 ...
 * from the library's assets so it will work on any version of Android. Until someone comes along all bad ass
 * and just fucking changes shit on ya making it more bad ass
 *
...
public class SilkBoldTextView extends TextView {
    ...
    private void init(Context context) {
        ...
        try {
            Typeface tf = Typeface.createFromAsset(context.getAssets(), "Corsiva.ttf");
            setTypeface(tf);
